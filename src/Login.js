        ...
        <div className="login">
            ...
            <div className="login__container">
                ...
                <form action="">
                    ...
                    <button type="submit" className="login__signin" onClick={signIn}>Login</button>
                </form>
